...
* [ ] Make sure that learning objectives in the book align with course material
      shared.
...
* Gain basic programming skills by writing programs using the Processing
...
* Begin to think abstractly by visiting algorithms *before* coding them.
