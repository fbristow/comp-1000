...
3. [*comp1020-compile-and-run-from-ide] [=comp1010-write-and-run]
   [=comp1500-write-program-given-solution]
...
8. [*comp1010-write-simple-functions] [=comp1500-custom-functions]
   [=comp1020-write-and-call-java-methods]
9. [*comp1010-functions-with-params-return]
10. Extract "sentinel" values into named constants.
    [=comp1010-identify-constant-values]
    [~comp1010-compare-constants-and-variables] :program:
11. [*comp1010-basic-print-debugging]
12. Get keyboard input using the `Scanner` class and the `nextInt` method.
...
8. [*comp1010-implement-linear-search]
   [~comp1020-write-binary-and-linear-search]
9. [*comp1010-implement-binary-search]
   [~comp1020-write-binary-and-linear-search]
10. [*comp1020-compare-searching-algorithms]
11. [*comp1020-describe-basic-sorting-algorithms]
12. [*comp1020-write-sorting-algorithms]
13. [*comp1020-compare-sorting-algorithms]
...
7. [*comp1010-string-comparison]
8. [*comp1020-explain-basic-oo-concepts]
9. [*comp1020-create-and-use-a-class]
10. [*comp1010-create-and-use-boolean-variables]
11. [*comp1020-evaluate-method-overloading]
12. [*comp1020-composite-objects]
13. [*comp1020-write-self-referencing-classes]
14. [*comp1020-create-and-use-subclasses]
15. [*comp1020-decide-which-property-is-referred-to-in-scope]
16. [*comp1020-upcast-and-downcast-instances]
17. [*comp1020-design-a-hierarchy-before-use]
18. [*comp1020-describe-mental-model-of-hierarchy]
...
2. [*comp1010-convert-numbers-strings]
3. [*comp1020-tokenizing-strings]
4. [*comp1010-create-use-char]
5. [*comp1010-use-nested-loops]
6. [*comp1010-use-nested-mixed-control-structures]
7. [*comp1010-use-flags-for-events]
8. [*comp1010-accumulate-data]
