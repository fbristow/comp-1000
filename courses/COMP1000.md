...
* Use an online circuit simulator, like <https://logic.ly>.
...
* [*comp1020-explain-basic-oo-concepts]
* [*comp1020-create-and-use-a-class]
* [*comp1020-evaluate-method-overloading]
* [*comp1020-composite-objects]
* [*comp1020-write-self-referencing-classes]
* [*comp1020-create-and-use-subclasses]
* [*comp1020-decide-which-property-is-referred-to-in-scope]
* [*comp1020-upcast-and-downcast-instances]
* [*comp1020-design-a-hierarchy-before-use]
* [*comp1020-describe-mental-model-of-hierarchy]
...
* [*comp1020-read-and-write-files] [=comp1020-read-from-a-file]
* [*comp1020-tokenizing-strings]
...
* [*comp1020-compare-data-structures] [=comp1010-list-array-limitations]
  [=comp1020-differences-between-list-and-array]
* [*comp1020-create-and-use-linked-list-class] [=comp1020-lists-for-collections]
* [*comp1020-choose-a-reasonable-data-structure]
...
* [*comp1020-write-recursive-code-given-algorithm]
* [*comp1020-describe-mental-model-of-recursion-as-stack]
* [*comp1020-explain-limitations-of-recursion]

Learning objectives not covered in COMP 1000 {#missing-objectives -}
============================================

The following learning objectives are covered in COMP 1010, COMP 1020, and COMP
1500, but are *not* referred to or used in COMP 1000.
