...
3. [*comp1010-write-and-run] [=comp1500-write-program-given-solution]
   [=comp1020-compile-and-run-from-ide]
   [=comp1020-write-compile-run-hello-world-java]
   
##### Create and use variables in a program

By the end of this unit, students should be able to:

1. [*comp1020-use-naming-conventions]
2. [*comp1010-declare-use-variables] [~comp1500-variables]
   [=comp1020-use-primitives] [=comp1020-use-variables-in-java]
3. [*comp1010-create-use-strings] [=comp1020-use-strings]
   [=comp1020-use-add-concat-operator]
4. [*comp1010-determine-expression-type] [=comp1020-predict-type-of-expression]
5. [*comp1010-write-evaluate-arithmetic-expressions]
   [=comp1500-visual-language-simple-sequence]
   [=comp1020-use-arithmetic-operators]
6. [*comp1010-choose-meaningful-names] [=comp1020-choose-concise-variable-names]
7. [*comp1010-comments] [=comp1020-use-comments]
8. [*comp1020-assignment-expressions-with-types]

##### Create and use methods in a program 

By the end of this unit, students should be able to:

1. [*comp1010-write-simple-functions] [=comp1500-custom-functions]
   [=comp1020-write-and-call-java-methods]
2. [*comp1010-functions-with-params-return]
3. [*comp1020-file-scoped-static-variables]
4. [*comp1010-use-named-constants] [=comp1020-use-named-constants-java]

##### Get and use input in a program

By the end of this unit, students should be able to:

1. [*comp1020-input-with-scanner] [=comp1010-accept-use-input]
   [=comp1500-visual-io] [=comp1500-io]
...
4. [*comp1010-call-math-library-functions]
5. [*comp1010-use-different-number-types]
6. [*comp1010-casting-between-number-types]
   [=comp1020-use-upcasting-downcasting]
7. [*comp1010-evaluate-casting-in-expression]
8. [*comp1010-explain-float-equality]

##### Write code concisely

By the end of this unit, students should be able to:

1. [*comp1010-use-compound-operator]
   [=comp1020-use-increment-decrement-operators]
   [=comp1020-use-compound-operators]
2. [*comp1020-use-boolean-expressions-with-operators]

##### Write and use conditional statements in a program

By the end of this unit, students should be able to:

1. [*comp1010-create-and-use-boolean-variables] [~comp1500-logical-expressions]
2. [*comp1010-evaluate-boolean-expressions-logical-operators]
    [=comp1500-logical-expressions]
3. [*comp1010-use-conditional-statements] [=comp1500-conditional-statements]
   [=comp1020-conditional-statements]
4. [*comp1010-use-relational-operators]
5. [*comp1010-evaluate-complex-boolean-expression]
6. [*comp1010-string-comparison]
7. [*comp1010-use-short-circuit-boolean-expressions]
8. [*comp1010-evaluate-short-circuit-boolean-expressions]
9. [*comp1010-else-if-nested-blocks] [=comp1500-conditional-statements]

##### Write and use looping structures in a program

By the end of this unit, students should be able to:

1. [*comp1010-use-basic-loops] [=comp1500-looping]
2. [*comp1010-evaluate-loop-execution]
3. [*comp1010-debug-with-stack-trace]
4. [*comp1010-use-nested-loops]
5. [*comp1010-evaluate-nested-loop-execution]
6. [*comp1010-use-nested-mixed-control-structures]
7. [*comp1010-accumulate-data]
